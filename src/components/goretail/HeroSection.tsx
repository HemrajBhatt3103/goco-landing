  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-1/3 left-1/4 w-[500px] h-[500px] bg-secondary/5 rounded-full blur-3xl" />
      </motion.div>
      ...
      >
        ...
        <motion.h1
          ...
          initial="hidden"
          animate="visible"
          className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-semibold tracking-tight text-secondary mb-6"
        >
          Your store deserves
          <br />
        ...
        >
          GoRetail turns your physical store into a digital catalog.
          Customers scan a QR code and browse your products instantly on their phone.
        </motion.p>
