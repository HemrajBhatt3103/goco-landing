      ...
      <div ref={ref} className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-lg text-primary/60 max-w-xl mx-auto mb-10">
            Start using GoRetail today.
            Get fast onboarding and dedicated support for your store.
          </p>
        </motion.div>
        ...
        >
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05, y: -2 }}
            whileTap={{ scale: 0.98 }}
            className="px-10 py-4 text-primary rounded-full text-sm font-medium tracking-wide hover:bg-primary/5 transition-colors border border-primary/10"
          >
            Book a Demo
          </motion.a>
        </motion.div>
